...
description: >
  ...
  Calendar; cross-references against the HubSpot CRM; proposes
  missing contacts, stale deal stages, and cold contacts that
  should be marked. NEVER writes to HubSpot. Only writes proposals
  to ~/work/echo/proposed-{date}.md.
tools:
  - mcp__gmail__search
...
3. Read the HubSpot CRM. Note every Contact, its associated Deal
...
4. Cross-reference. Find three categories of mismatch:
   ...
   - Cold without status: Contact, last contact > 30 days ago,
...
- Write to the HubSpot CRM. Not via any tool, ever.
